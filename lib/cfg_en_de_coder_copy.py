...
parser.add_argument('--continue_train', type=int, default=24, help='the number of starting train')
parser.add_argument('--dataset', required=False, default='unet_256_kalman_copy', help='unet_affine_temp')
parser.add_argument('--train', type=bool, default=False, help='unet_affine_temp')
parser.add_argument('--dir_logs', default='logs1', help='logs for tensorboard')
